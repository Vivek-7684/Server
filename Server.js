...
app.post("/signup", async (req, res) => {
    ...
    if (!validator.isAlpha(username.trim())) {  // remove white space in username from both side 
    ...
    connection.query("Select * from ecom_user where username = ? or email = ?", [username, email], (error, result) => {
